export default {
  ...
  data: [
    ...
    },
    {
      ...
      name: 'Heal',
      description:
        'Restores 90-345 Health (depending on champion level) and grants 30% Move Speed for 1 second to you and target allied champion. This healing is halved for units recently affected by Summoner Heal.',
      tooltip:
        'Restores {{ f1 }} Health and grants 30% Move Speed for 1 second to your champion and target allied champion. This healing is halved for units recently affected by Summoner Heal.<br /><br /><span class="colorFFFF00">If this spell cannot find a target, it will cast on the most wounded allied champion in range.</span>',
      maxrank: 1,
      cooldown: [240],
      cooldownBurn: '240',
      cost: [0],
    ...
    },
    {
      ...
      tooltip: 'Will be replaced by your Ultimate Summoner Spell selection.',
      maxrank: 1,
      cooldown: [0],
      cooldownBurn: '0',
      cost: [0],
    ...
    },
    {
      ...
      tooltip:
        'Will be replaced by your Ultimate Summoner Spell.<br /><br />Gain Attack-Smite. Attack-Smite will execute allied Buff Monsters, Epic Monsters, and Scuttle Crabs when you attack them.<br /><br /><attention>Attack-Smite does not have a cooldown.</attention>',
      maxrank: 1,
      cooldown: [0],
      cooldownBurn: '0',
      cost: [0],
